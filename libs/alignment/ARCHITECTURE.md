...
> `SPK_AltAz_Goto_Convention_Regression` for the regression test that catches this class
> of bug.
...
Both directions are exercised by `test/alignment/test_pointing_model.cpp`.
